...
export default function Section2() {
  return (
    <section className="h-screen w-full text-white">
      <section class="bg-gradient-to-l from-gray-700 via-gray-900 to-black text-white grid grid-cols-2 h-full w-full">
        <div className="">
          <h1>kin</h1>
        </div>
        <div>
          <img
            className="lol"
            src="https://img.freepik.com/premium-photo/futuristic-cloud-computing-technology-conceptgenerative-ai_861549-168.jpg?w=1060"
            alt=""
          />
        </div>
      </section>
